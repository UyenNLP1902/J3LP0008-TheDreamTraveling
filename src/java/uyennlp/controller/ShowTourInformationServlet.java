 ...
 * @author HP
 */
public class ShowTourInformationServlet extends HttpServlet {

    private final static Logger log = Logger.getLogger(ShowTourInformationServlet.class);
    private final String ERROR_PAGE = "error.html";
    private final String DETAIL_PAGE = "tourInfo.jsp";
